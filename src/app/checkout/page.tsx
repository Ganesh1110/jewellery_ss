    ...
    <div className="flex min-h-[60vh] items-center justify-center px-4 py-20">
      <div className="w-full max-w-lg text-center">
        ...
        <h1 className="font-heading text-display-md tracking-tight text-neutral-950 mb-5">
          Place your order from the bag
        </h1>
        <p className="text-body text-neutral-600 mb-10 leading-relaxed">
          Open your shopping bag and confirm checkout — the order is stored in the
          database and payment is captured as Cash on Delivery.
        </p>
